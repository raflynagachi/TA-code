...
st.markdown("""
Insert a secret message and cover image. Secrets message will be embedded into image using the DCT steganography method. 
Secret messages can be compressed (_optional_) using deflate compression to reduce the size of the message to be embedded.
    
Button:  
**compress** ==> compressing secret message using deflate compression (_optional_)  
**process** ==> embedding secret message into image (_image and secret message are required_)
""")
